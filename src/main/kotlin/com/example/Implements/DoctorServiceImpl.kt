...
class DoctorServiceImpl(private val db: CoroutineDatabase,private val NotificationService: Notification) : DoctorService {
    ...
    override suspend fun updateDoctorProfile(id: String, request: Doctor): Pair<Boolean, String> {
        ...
        request.gender?.let { lst.add(Doctor::gender setTo it) }
        ...
        request.url?.let { lst.add(Doctor::url setTo it) }
